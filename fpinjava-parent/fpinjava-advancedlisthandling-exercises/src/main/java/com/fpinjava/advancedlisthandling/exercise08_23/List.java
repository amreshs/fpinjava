...
public abstract class List<A> {
    ...
    private static void test(final int n, final List<Long> lst, final ExecutorService es) {
        for (int i = 0; i < n; i++) {
            Result<BigInteger> result = lst.parFoldLeft(es, BigInteger.ZERO, a -> b -> a.add(BigInteger.valueOf(fibo(b))), a -> a::add);
