...
public class TreeTest {
  ...
  static final Tree<Integer> orderedTree1 = orderedTestList1.foldLeft(Tree.empty(), m -> a -> m.insert(a));
  static final Tree<Integer> orderedTree2 = orderedTestList2.foldLeft(Tree.empty(), m -> a -> m.insert(a));
  static final Tree<Integer> randomTree1 = randomTestList1.foldLeft(Tree.empty(), m -> a -> m.insert(a));
  static final Tree<Integer> randomTree2 = randomTestList2.foldLeft(Tree.empty(), m -> a -> m.insert(a));

  Tree<Integer> tree1 = List.list(3, 1, 5, 0, 2, 4, 6, 7).foldLeft(Tree.empty(), m -> a -> m.insert(a));
  Tree<Integer> tree2 = List.list(5, 3, 7, 1, 4, 6, 8, -2).foldLeft(Tree.empty(), m -> a -> m.insert(a));
  Tree<Integer> tree3 = List.list(3, 7, 1, 4, 6, 8, -1, 9).foldLeft(Tree.empty(), m -> a -> m.insert(a));
  ...
  public void testMerge3() {
    ...
    assertTrue(List.concat(randomTestList1, randomTestList2).forAll(a -> mergedTree.member(a)));
  }
  ...
  public void testMerge5() {
    ...
    assertTrue(List.concat(orderedTestList1, orderedTestList2).forAll(a -> mergedTree.member(a)));
  }
  ...
  public void testMerge7() {
    ...
    assertTrue(List.concat(randomTestList1, orderedTestList2).forAll(a -> mergedTree.member(a)));
  }

  @Test
  public void testMerge8() {
    Tree<Integer> mergedTree = randomTree2.merge(orderedTree1);
    assertTrue(List.concat(randomTestList2, orderedTestList1).forAll(a -> mergedTree.member(a)));
  }
}
