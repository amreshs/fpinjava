...
abstract class Stream<A> {
  ...
  public static Stream<Integer> fibs() {
    ...
    return unfold(new Tuple<>(0, 1), x -> Result.success(new Tuple<>(x._1, new Tuple<>(x._2, x._1+x._2))));
  }

  public static void main(String[] args) {
    System.out.println(from(1).take(10).toList());
    System.out.println(fibs().take(20).toList());
  }
}
